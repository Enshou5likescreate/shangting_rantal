...
public class SystemUserController {
    ...
    public Result<IPage<SystemUserItemVo>> page(@RequestParam long current, @RequestParam long size, SystemUserQueryVo queryVo) {
        Page<SystemUserItemVo> userItemVoPage = new Page<>();
        IPage<SystemUserItemVo> result = systemUserService.pageSystemUser(userItemVoPage,queryVo);
...
//        //元のmd5Hexは技術の発展による解読されやすいリスクがあるため、より安全性高いSpring Familyのspring-boot-starter-securityを用いて、パスワードを守る
//        if (systemUser.getPassword() != null) {
